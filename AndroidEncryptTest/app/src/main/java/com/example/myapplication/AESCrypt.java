...
public final class AESCrypt {
     ...
     */
    public static String decrypt2(final String password, String base64EncodedCipherText)
            throws GeneralSecurityException {
        ...
        try {
            ...
            final String iv = "e84ad660c4721ae0e84ad660c4721ae0";
            //String SecretKey = "1234567890123456";
            final String secretKey = "insight123resultxyz";

            //ivspec = new IvParameterSpec(iv.getBytes());
            keyspec = new SecretKeySpec(secretKey.getBytes("UTF-8"), "AES");

            final byte[] _ivBytes = iv.getBytes("UTF-8");
            ...
            byte[] decryptedBytes = decrypt(keyspec, _ivBytes, decodedCipherText);
